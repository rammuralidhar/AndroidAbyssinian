...
public final class CalligraphyUtils {
     ...
     * set in {@link com.abyssinian.android.ext.font.CalligraphyConfig}
     *
    ...
    public static void applyFontToTextView(final Context context, final TextView textView, final CalligraphyConfig config, final String textViewFont, boolean deferred) {
        if (context == null || textView == null || config == null) return;
