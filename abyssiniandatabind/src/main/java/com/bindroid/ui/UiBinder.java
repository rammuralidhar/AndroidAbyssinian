...
public final class UiBinder {
  ...
  /**
   * Binds a view within an {@link android.app.Activity} to the given property on the Activity itself.
   * 
   * @param activity
   *          the parent Activity.
   * @param targetId
  ...
  public static Binding bind(Activity activity, int targetId, String targetProperty,
    ...
    return UiBinder.bind(activity, targetId, targetProperty, sourceProperty, BindingMode.ONE_WAY,
        ValueConverter.getDefaultConverter());
  }
  ...
  /**
   * Binds a view within a {@link android.view.View} to the given property.
   * 
   * @param view
   *          the parent View.
   * @param targetId
  ...
  /**
   * Binds a view within a {@link android.view.View} to the given property on the View itself.
   * 
   * @param view
   *          the parent View.
   * @param targetId
  ...
  public static Binding bind(View view, int targetId, String targetProperty, String sourceProperty) {
    return UiBinder.bind(view, targetId, targetProperty, view, sourceProperty, BindingMode.ONE_WAY,
        ValueConverter.getDefaultConverter());
  }
