...
/**
 * Provides a {@link android.widget.ListAdapter} or {@link android.widget.SpinnerAdapter} to wrap a {@link TrackableCollection},
 * listening for changes to the collection and notifying any UI using the adapter of those changes.
 * 
 * If the {@link android.view.View} type that this adapter creates implements {@link com.bindroid.ui.BoundUi}, each item the
