...
/**
 * Represents the "Checked" property of a {@link android.widget.CompoundButton} (e.g. a CheckBox or ToggleButton),
...
public class CompoundButtonCheckedProperty extends Property<Boolean> {
  ...
  /**
   * Constructs a CompoundButtonCheckedProperty for a {@link android.widget.CompoundButton}.
   * 
   * @param button
