...
/**
 * Provides an object to which {@link com.bindroid.trackable.Tracker} can subscribe for notifications as well as methods
 * that allow a Tracker to evaluate an {@link com.bindroid.utils.Action} or {@link com.bindroid.utils.Function} while subscribing to
...
public class Trackable {
  ...
  /**
   * Causes a {@link com.bindroid.trackable.Tracker} to track any Trackables on which {@link #track()} was called while
   * executing the given {@link com.bindroid.utils.Action}. {@link com.bindroid.trackable.Tracker#update()} will be called at most once for
  ...
  /**
   * Causes a {@link com.bindroid.trackable.Tracker} to track any Trackables on which {@link #track()} was called while
   * evaluating the given {@link com.bindroid.utils.Function}. The result of the function is returned.
   * {@link com.bindroid.trackable.Tracker#update()} will be called at most once for all Trackables tracked while
  ...
  /**
   * Captures any {@link com.bindroid.trackable.Tracker}s that are configured to {@link #track(com.bindroid.trackable.Tracker, com.bindroid.utils.Action)} this
  ...
  /**
   * Notifies any {@link com.bindroid.trackable.Tracker}s watching this Trackable.
   */
